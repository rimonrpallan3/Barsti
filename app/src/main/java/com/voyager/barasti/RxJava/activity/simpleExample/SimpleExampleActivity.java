package com.voyager.barasti.RxJava.activity.simpleExample;
...
import com.voyager.barasti.RxJava.activity.simpleExample.utils.AppConstant;
...
public class SimpleExampleActivity extends AppCompatActivity {
   ...
   */
    private void doSomeWorks() {
        getObservables().delay(1, TimeUnit.SECONDS)
                // Run on a background thread
                .subscribeOn(Schedulers.io())
                // Be notified on the main thread
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(getObservers());
    }
    ...
    private Observer<String> getObservers() {
